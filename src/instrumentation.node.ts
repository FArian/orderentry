/**
 * Node.js-only instrumentation — loaded exclusively by the Node.js runtime.
 *
 * Next.js 15 will NEVER load this file in the Edge runtime, which means
 * Vercel's Edge bundler never sees the @opentelemetry/* imports and will
 * not attempt to resolve them for the middleware bundle.
 *
 * Activation:
